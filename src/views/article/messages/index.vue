    ...
    <div class="view-base-table">
      <el-table :data="tableData" border row-key="id" @selection-change="selectionChange">
        ...
        <el-table-column prop="isReply" label="是否可回复" width="100" align="center">
          <template #default="scope">
            <el-tag v-if="scope.row.parentId === 0 && scope.row.isReply === '1'" type="primary">是</el-tag>
            <el-tag v-else-if="scope.row.parentId === 0" type="info">否</el-tag>
            <span v-else>-</span>
          </template>
        </el-table-column>
        <el-table-column prop="isPrivate" label="是否私密" width="100" align="center">
          <template #default="scope">
            <el-tag v-if="scope.row.parentId === 0 && scope.row.isPrivate === '1'" type="primary">是</el-tag>
            <el-tag v-else-if="scope.row.parentId === 0" type="info">否</el-tag>
            <span v-else>-</span>
          </template>
        </el-table-column>
